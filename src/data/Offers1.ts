...
export const productsData: Product[] = [
  ...
  },
  {
    ...
    howToUse: "Wet skin with lukewarm water. Massage cleanser into skin in gentle circular motion. Rinse thoroughly and pat dry. Use morning and night.",
    ingredients: ["Ceramides 1, 3, 6-II", "Hyaluronic Acid", "Glycerin", "MVE Technology"],
    similarProducts: ["rare-beauty-tinted", "laneige-lip-mask", "olive-june-serum"],
  },
  {
    id: "mielle-scalp-oil",
    category: "Hair Care",
    ...
    pickup: "Pickup available at Beauty Hub Nairobi",
    paymentOptions: ["M-Pesa", "Credit Card", "Visa"],
    description: "Nourishing scalp oil to promote healthy hair growth.",
    fullDescription:
      "This nutrient-rich, intensive formula is infused with biotin and certified organic ingredients like rosemary and mint to support a healthy scalp environment and strong, growing hair. The lightweight oil absorbs quickly without leaving greasy residue.",
    howToUse: "Apply directly to scalp and massage in with fingertips. Can be used on damp or dry hair. Use 2-3 times per week or as needed.",
    ingredients: ["Biotin", "Rosemary Oil", "Peppermint Oil", "Coconut Oil", "Jojoba Oil"],
    similarProducts: ["cerave-cleanser", "olive-june-serum", "laneige-lip-mask"],
  },
];
